...
def main():
    ...
    project_json = parser.create_project_json(
        owner='ThakurDivyanshsingh-77', #dont forget to change this to your github username
        ...
        description='An open source interactive portfolio website, with a clean and modern design, sections for education, experience, skills, competitions, and more. Built with Next.js, Tailwind CSS, TypeScript, React, MongoDB, and Vercel.', #dont forget to change this to your project description
        repo_url='https://github.com/ThakurDivyanshsingh-77/portfolio', #dont forget to change this to your github repo url
        live_url='', #dont forget to change this to your live website url or leave it blank if you dont have one
        tech_stack=['Next.js', 'Tailwind CSS', 'TypeScript', 'React', 'MongoDB', 'Vercel'] #dont forget to change this to your project tech stack
    )
